...
This is a module for GP2X Linux kernel, created for developers to use in their
programs.
...
Note: the original module, accessible through archive.gp2x.de, was only hacking
memory range 0x02000000-0x0200ffff, which is in most cases not used for
anything, making it completely ineffective. However, many authors used it in
their projects. If you are one of them, you should update your program.
...
Original idea: Squidge (this whole thing is also known as squidgehack)
Kernel module: NK
Documentation: notaz
